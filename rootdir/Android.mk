...
include $(CLEAR_VARS)
LOCAL_MODULE       := init.recovery.P15945AA1.rc
LOCAL_MODULE_TAGS  := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_SRC_FILES    := etc/init.recovery.P15945AA1.rc
...
include $(CLEAR_VARS)
LOCAL_MODULE       := ueventd.P15945AA1.rc
LOCAL_MODULE_TAGS  := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_SRC_FILES    := etc/ueventd.P15945AA1.rc
LOCAL_MODULE_PATH  := $(TARGET_ROOT_OUT)
include $(BUILD_PREBUILT)
